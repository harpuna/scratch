...
function CustomerTable() {
    ...
    return (
        <div>
            ...
            {selectedCustomer && (
                ...
                <div className="form-container">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <br/>
                        <label>Email:</label>
                        <input type="email" name="email" value={selectedCustomer.email} onChange={handleChange}
                               required/>
                        <br/>
                        <label>Note:</label>
                        ...
                        <button type="button" className="cancel-btn" onClick={() => setSelectedCustomer(null)}>Cancel
                        </button>
                    </form>
            ...
            {/*                        <td>{order.total_amount_in_cents}</td>*/}
            {/*                    </tr>*/}
            {/*                ))}*/}
            {/*                </tbody>*/}
            {/*            </table>*/}
